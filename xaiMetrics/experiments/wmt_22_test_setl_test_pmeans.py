...
# Run experiments on wmt22 qe test sets
...
for lp in lps:
    ...
    print("Explaining:", lp)
    df = pd.read_csv(
        os.path.join(ROOT_DIR, "xaiMetrics", "data", "wmt22_test_sets", "wmt22_{set}_{lp}.tsv".format(lp=lp, set="test")),
        delimiter='\t')
